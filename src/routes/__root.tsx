...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "A S Vincent — Cybersecurity Enthusiast & Developer" },
      ...
      { name: "author", content: "A S Vincent" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://api.fontshare.com/v2/css?f[]=aventa@400,500,600,700,800&display=swap",
      },
      {
        rel: "stylesheet",
